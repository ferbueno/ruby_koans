...
This repo was created for making the life a little easier for someone who wants to learn Ruby. It's the `Ruby Koans` you can find [here](http://rubykoans.com/).

Special thanks to EdgeCase who built them!

This markdown is based on the original documentation written with `rdoc`.
